    ...
    <div ref={rootRef} className="bg-[#fff8f3] text-[#1d1b18]">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <section className="max-w-[1200px] mx-auto px-5 sm:px-6 md:px-12 pt-8 pb-16 md:pt-14 md:pb-24 reveal-entry">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <h1
              className="font-bold tracking-[-0.04em] text-[#1d1b18] mt-6 mb-6 text-[38px] leading-[46px] md:text-[56px] md:leading-[64px]"
      ...
      <section className="max-w-[1200px] mx-auto px-5 sm:px-6 md:px-12 py-20 md:py-28 w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-6 reveal-entry">
          <div className="max-w-xl">
            <h2
              className="font-['Plus_Jakarta_Sans',sans-serif] text-[#1d1b18] text-[28px] md:text-[36px] leading-[36px] md:leading-[44px] tracking-[-0.04em] font-bold"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch reveal-entry">
          {/* Tier 1 */}
          <div
            className="flex flex-col justify-between bg-white rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-xl transition-all duration-300 group border border-[#dfc0b7]/20"
          >
            <div>
              ...
              <h3
                className="font-['Plus_Jakarta_Sans',sans-serif] text-[#1d1b18] text-[22px] md:text-[24px] leading-9 font-bold tracking-[-0.04em] mb-3"
              >
              ...
              <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] leading-6 text-[#58423c] mb-6">
                ...
                never fill, slow floor drains and burst flexi-hoses under the basin. New and existing homes.
              </p>
              <div className="py-4 my-6 bg-[#f9f2ed] rounded-xl px-5 flex flex-col border border-[#dfc0b7]/15">
                <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[13px] font-semibold tracking-[0.04em] uppercase text-[#58423c]">
          ...
          {/* Tier 2 Highlighted */}
          <div
            className="flex flex-col justify-between bg-white rounded-2xl p-8 md:p-10 shadow-md hover:shadow-2xl transition-all duration-300 relative border border-[#dfc0b7]/20"
          >
            <div>
              ...
              <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] leading-6 text-[#58423c] mb-6">
                ...
                and whole-house filtration without the hum or airlocks. For new sites and retrofits.
              </p>
          ...
          >
            <div>
              ...
              <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] leading-6 text-[#58423c] mb-6">
                ...
                mixers, and whole-house PPR/PEX runs with laser-set slopes. For new builds and renovations.
              </p>
              <div className="py-4 my-6 bg-[#f9f2ed] rounded-xl px-5 flex flex-col border border-[#dfc0b7]/15">
                <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[13px] font-semibold tracking-[0.04em] uppercase text-[#58423c]">
                  Typical Billing Framework
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 flex flex-col">
              ...
              <h2
                className="font-['Plus_Jakarta_Sans',sans-serif] text-[#f6f0ea] text-[28px] md:text-[36px] leading-[1.15] font-bold tracking-[-0.04em] mb-6"
              >
            ...
            {/* Proof of Workmanship card — simplified */}
            <div className="lg:col-span-5">
              <div className="bg-white text-[#1d1b18] rounded-2xl p-8 shadow-xl relative overflow-hidden flex flex-col justify-between border border-[#dfc0b7]/20">
                <div className="flex items-start justify-between border-b border-[#dfc0b7]/30 pb-6 mb-6">
                  <div>
                    <h4
                      className="font-['Plus_Jakarta_Sans',sans-serif] text-[#1d1b18] text-[20px] leading-8 font-bold tracking-[-0.04em] mt-1"
                    >
                      Proof of Workmanship
                    </h4>
                    <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[14px] leading-5 text-[#58423c] mt-1">Workmanship backing — warranty doc on request</p>
                  </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-center justify-between gap-4 py-2.5 bg-[#f9f2ed] px-4 rounded-lg">
                    <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] text-[#58423c]">Scope Covered</span>
                    <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[14px] font-semibold text-[#1d1b18] text-right">
                      All Joints, Welds & Seals
                    </span>
                  </div>
                  <div className="flex items-center justify-between gap-4 py-2.5 bg-[#f9f2ed] px-4 rounded-lg">
                    <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] text-[#58423c]">Verification</span>
                    <span className="font-['Plus_Jakarta_Sans',sans-serif] text-[14px] font-semibold text-[#1d1b18] text-right">
                      Pressure Test Video
                    </span>
                  </div>
      ...
      <section className="max-w-[1200px] mx-auto px-5 sm:px-6 md:px-12 py-20 md:py-28 w-full reveal-entry">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 rounded-2xl bg-[#f9f2ed] shadow-sm flex flex-col justify-between border border-[#dfc0b7]/20">
            <div>
              <h3 className="font-['Plus_Jakarta_Sans',sans-serif] text-[18px] font-bold leading-7 tracking-[-0.04em] text-[#1d1b18] mb-3">
                No payments for remote photo reviews
              </h3>
              <p className="font-['Plus_Jakarta_Sans',sans-serif] text-[15px] leading-6 text-[#58423c]">
            ...
            <div className="mt-6 pt-4 border-t border-[#dfc0b7]/20 flex items-center gap-2 text-[#a43716] font-['Plus_Jakarta_Sans',sans-serif] text-[14px] font-semibold">
